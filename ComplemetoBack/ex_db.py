...
def importation():
    ...
    return render_template('SU Exportaciones.html', una_lista=['Tipo ZAP Academy', 'Tipo Apoyo a Mujeres',
...
def exports():
    export()
    return render_template('SU Exportaciones.html', my_list=('Tipo ZAP Academy',
